...
function getGenerativeModel(modelName = DEFAULT_MODEL) {
    ...
    } else if (modelName === "alibaba/qwen3-max-preview"
        || modelName === "google/gemini-3-pro-preview"
        || modelName === "deepseek/deepseek-non-thinking-v3.2-exp"
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const chat = (typeof model.startChat === 'function') ? model.startChat({}) : new OpenAIChatSession(model, selectedModel);
